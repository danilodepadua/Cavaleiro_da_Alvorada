...
public class Mythágoras extends Cidade {
    public Mythágoras() throws PlayerInexistenteException {
        super("Mythágoras", "/com.daniel.Images/Fundos/Dasopoles.jpg", "/com.daniel.Images/Fundos/FundoBatalhaBosque.jpg");

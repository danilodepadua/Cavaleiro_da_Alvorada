...
public class InimigoTigerMan extends Inimigo {
    public InimigoTigerMan() {
        super("Tigrinho", "/com.daniel.Images/Inimigos/Weretiger Maxima.png", 33, 50, 40, 25, 60, 20, 10, 40, 20, 500, 200, TiposElementais.NaoElemental, Comportamentos.padrao, 100, 5);

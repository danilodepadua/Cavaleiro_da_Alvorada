...
public class InimigoSlimeRei extends Inimigo {
    public InimigoSlimeRei() {
        super("Rei dos slimes", "/com.daniel.Images/Inimigos/Slime RPG King.png", 36, 60, 50, 10, 50, 50,2990, 5, TiposElementais.NaoElemental, Comportamentos.padrao, 50000, 15000);

...
public class InimigoCobraGigante extends Inimigo {
    public InimigoCobraGigante() {
        super("Cobra gigante", "/com.daniel.Images/Inimigos/Colossal Snake Black.png", 42, 50, 45, 45, 45, 30,500, 250, TiposElementais.NaoElemental, Comportamentos.padrao, 25000, 3500);

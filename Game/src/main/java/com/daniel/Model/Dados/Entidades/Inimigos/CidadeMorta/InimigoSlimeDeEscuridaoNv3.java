...
public class InimigoSlimeDeEscuridaoNv3 extends Inimigo {
    public InimigoSlimeDeEscuridaoNv3() {
        super("Slime de escuridão grande", "/com.daniel.Images/Inimigos/Slime Darkiii.png", 33, 45, 25, 55, 25, 40,50, 25, TiposElementais.Escuridao, Comportamentos.padrao, 280, 120);

...
public class BossFinal1 extends Inimigo {
    public BossFinal1() {
        super("Mago abissal", "/com.daniel.Images/Inimigos/Dark Elves Crystal Mage.png", 39, 75, 80, 60, 55, 40,9000, 20000, TiposElementais.NaoElemental, Comportamentos.BossFinal1, 100000, 150000);

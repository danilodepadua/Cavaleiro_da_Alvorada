...
public class InimigoMosquito extends Inimigo {
    public InimigoMosquito() {
        super("Fly", "/com.daniel.Images/Inimigos/Vampiric Creatures Giant Mosquito.png", 44, 5, 2, 10, 15, 15,65, 10, TiposElementais.NaoElemental, Comportamentos.padrao, 100, 15);

...
public class InimigoTigerMan extends Inimigo {
    public InimigoTigerMan() {
        super("Tigrinho", "/com.daniel.Images/Inimigos/Weretiger Maxima.png", 34, 50, 20, 30, 50, 30,500, 200, TiposElementais.NaoElemental, Comportamentos.padrao, 10000, 2500);

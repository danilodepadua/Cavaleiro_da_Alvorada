...
public class InimigoSapo1 extends Inimigo {
    public InimigoSapo1() {
        super("Black Toxic Frog", "/com.daniel.Images/Inimigos/Toxic Frog A2.png", 34, 32, 3, 32, 34, 32,7500, 200, TiposElementais.NaoElemental, Comportamentos.padrao, 3000, 1500);
